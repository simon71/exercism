...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    current_reactor_effeciency = ((voltage * current) / theoretical_max_power) * 100

    if current_reactor_effeciency>= 80:
        return "green"
    elif current_reactor_effeciency< 80 and current_reactor_effeciency>= 60:
        return "orange"
    elif current_reactor_effeciency>= 30 and current_reactor_effeciency< 60:
        return "red"
    else:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    current_reactor_status = temperature * neutrons_produced_per_second
    current_reactor_threshold = current_reactor_status / threshold * 100

    if current_reactor_threshold < 90:
        return "LOW"
    elif current_reactor_threshold > 90 and current_reactor_threshold < 110:
        return "NORMAL"
    else:
        return "DANGER"

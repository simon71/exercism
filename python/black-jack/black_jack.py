...
def is_blackjack(card_one, card_two):
    ...
    if (card_one=='A' and (card_two in ['J', 'Q', 'K'] or card_two=='10')):
        return True
    elif (card_two=='A' and (card_one in ['J', 'Q', 'K'] or card_one=='10')):
        return True
    else:
        return False
...
def can_split_pairs(card_one, card_two):
    ...
    if card_one and card_two in ['J', 'K', 'Q'] or card_one==card_two:
        return True
    else:
        return False

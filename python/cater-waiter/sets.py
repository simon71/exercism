...
def categorize_dish(dish_name, dish_ingredients):
    ...
    catagories = { "VEGAN": VEGAN, "VEGETARIAN": VEGETARIAN, "PALEO": PALEO, "KETO": KETO, "OMNIVORE": OMNIVORE }

    for c in catagories:
        if dish_ingredients.issubset(catagories[c]):
            return f'{dish_name}: {c}'
...
def singleton_ingredients(dishes, intersection):
    ...
    for i in dishes:
        ingredients_list = ingredients_list ^ i
    return ingredients_list - intersection
